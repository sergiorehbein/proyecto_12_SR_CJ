...
##para Nguyen 8 se debe cambiar el dominio desde 0 para arriba dado que es un raísz cuadrada

#Diccionario para funciones con dos variables de entrada
nguyen_functions_2 = {
    "nguyen9": nguyen9,
    "nguyen10": nguyen10
}
...
if __name__ == "__main__":
    ...
    bench = Benchmark(**kwargs)
     ...
     # Ejecutar el benchmark para cada función
    for func_name, func in nguyen_functions_1.items():
        bench.benchmark(func, func_name=func_name, trials=20)
